...
namespace ZeissMachineStreamCore.Services
{
    ...
    public class WebSocketService : IWebSocket
    {
        ...
        private readonly ISaveData saveEvents;
        ...
        public WebSocketService(ISaveData saveEvents, IOptions<WebSocketConfiguration> optionsWebScoket, ILogger<WebSocketService> logger)
        {
            this.logger = logger;
        ...
        private void WSOnMessage(string message)
        {
            ...
            Task.Run(() => saveEvents.StoreEventAsync(streamEvent, webSocketConfiguration.FullUrl));
        }
